...
type Storage struct {
	...
	Driver Storage_Driver `protobuf:"varint,1,opt,name=driver,proto3,enum=tech.Storage_Driver" json:"driver,omitempty"`
...
var file_storage_message_proto_rawDesc = []byte{
	...
	0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x04, 0x74, 0x65, 0x63, 0x68, 0x1a, 0x14, 0x6d,
	...
	0x14, 0x2e, 0x74, 0x65, 0x63, 0x68, 0x2e, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x2e, 0x44,
	...
	0x74, 0x65, 0x63, 0x68, 0x2e, 0x4d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x52, 0x06, 0x6d, 0x65, 0x6d,
...
var file_storage_message_proto_goTypes = []interface{}{
	(Storage_Driver)(0), // 0: tech.Storage.Driver
	(*Storage)(nil),     // 1: tech.Storage
	(*Memory)(nil),      // 2: tech.Memory
}
var file_storage_message_proto_depIdxs = []int32{
	0, // 0: tech.Storage.driver:type_name -> tech.Storage.Driver
	2, // 1: tech.Storage.memory:type_name -> tech.Memory
