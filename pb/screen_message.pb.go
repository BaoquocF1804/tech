...
type Screen struct {
	...
	Panel      Screen_Panel       `protobuf:"varint,3,opt,name=panel,proto3,enum=tech.Screen_Panel" json:"panel,omitempty"`
...
var file_screen_message_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x04, 0x74, 0x65, 0x63, 0x68, 0x22, 0x8d, 0x02, 0x0a,
	...
	0x6f, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x74, 0x65, 0x63, 0x68, 0x2e,
	...
	0x65, 0x63, 0x68, 0x2e, 0x53, 0x63, 0x72, 0x65, 0x65, 0x6e, 0x2e, 0x50, 0x61, 0x6e, 0x65, 0x6c,
...
var file_screen_message_proto_goTypes = []interface{}{
	(Screen_Panel)(0),         // 0: tech.Screen.Panel
	(*Screen)(nil),            // 1: tech.Screen
	(*Screen_Resolution)(nil), // 2: tech.Screen.Resolution
}
var file_screen_message_proto_depIdxs = []int32{
	2, // 0: tech.Screen.resolution:type_name -> tech.Screen.Resolution
	0, // 1: tech.Screen.panel:type_name -> tech.Screen.Panel
