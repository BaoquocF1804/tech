...
type Memory struct {
	...
	Unit  Memory_Unit `protobuf:"varint,2,opt,name=unit,proto3,enum=tech.Memory_Unit" json:"unit,omitempty"`
}
...
var file_memory_message_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x04, 0x74, 0x65, 0x63, 0x68, 0x22, 0xa5, 0x01, 0x0a,
	...
	0x63, 0x68, 0x2e, 0x4d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x2e, 0x55, 0x6e, 0x69, 0x74, 0x52, 0x04,
...
var file_memory_message_proto_goTypes = []interface{}{
	(Memory_Unit)(0), // 0: tech.Memory.Unit
	(*Memory)(nil),   // 1: tech.Memory
}
var file_memory_message_proto_depIdxs = []int32{
	0, // 0: tech.Memory.unit:type_name -> tech.Memory.Unit
