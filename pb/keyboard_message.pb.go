...
type Keyboard struct {
	...
	Layout  Keyboard_Layout `protobuf:"varint,1,opt,name=layout,proto3,enum=tech.Keyboard_Layout" json:"layout,omitempty"`
...
var file_keyboard_message_proto_rawDesc = []byte{
	...
	0x67, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x04, 0x74, 0x65, 0x63, 0x68, 0x22, 0x8e,
	...
	0x63, 0x68, 0x2e, 0x4b, 0x65, 0x79, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x2e, 0x4c, 0x61, 0x79, 0x6f,
...
var file_keyboard_message_proto_goTypes = []interface{}{
	(Keyboard_Layout)(0), // 0: tech.Keyboard.Layout
	(*Keyboard)(nil),     // 1: tech.Keyboard
}
var file_keyboard_message_proto_depIdxs = []int32{
	0, // 0: tech.Keyboard.layout:type_name -> tech.Keyboard.Layout
